...
function sendMail(event) {
  ...
  // Format mailto link
  const mailtoLink = `mailto:aditya.chaurasia8991@gmail.com&subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(message)}%0D%0AName: ${encodeURIComponent(name)}`;
